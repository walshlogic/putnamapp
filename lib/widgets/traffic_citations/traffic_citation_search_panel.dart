...
/// Search and filter panel for traffic citations screen
class TrafficCitationSearchPanel extends StatelessWidget {
  const TrafficCitationSearchPanel({
        ...
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search by name (lastname, firstname), license plate, or case number...',
              hintStyle: TextStyle(
                fontSize: 14,
