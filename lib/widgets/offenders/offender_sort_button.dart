...
class OffenderSortButton extends StatelessWidget {
  const OffenderSortButton({
    required this.label,
    required this.field,
  ...
  void _handleTap() {
    if (!_isActive) {
      ...
      // Third tap: turn off sorting (reset to name ascending)
      onSortChanged(SortField.name, SortDirection.ascending);
    }
  }
}
